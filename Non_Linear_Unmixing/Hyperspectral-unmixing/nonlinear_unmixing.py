...
#load the envi files
path = os.getcwd() + '/samson/'
# path = '/home/shahin/Desktop/Mid_Term/Non_Linear_Unmixing/Hyperspectral-unmixing/samson/'
img = envi.open(path + 'samson_1.img.hdr', path + 'samson_1.img')
print(img)
arr = img.load()
print(arr.__class__)
arr = np.array(arr)
...
mat = spio.loadmat(path + 'end3.mat')
print(mat.keys())
gt = mat['A']
gt = gt.T
